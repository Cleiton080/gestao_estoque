    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text'  => 'Fornecedor',
                    'url'   => '/busca/fornecedor',
                ],
                [
                    'text'  => 'Funcionário',
                    'url'   => '/busca/funcionario',
                ],
                [
                    'text'  => 'Produto',
                    'url'   => '/busca/produto',
        ...
        [
            'text'  => 'Transportadora',
            'url'   => '/busca/transportadora',
        ],
        [
            'text' => 'Lista',
            'url'  => '/estorno_pendentes',
            'icon' => 'list',
        ],
        [
            'text'    => 'Movimentação',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Acessos',
                    'url' => '/relatorio/acessos',
                ],
                [
                    'text' => 'Cadastros',
                    'url' => '/relatorio/cadastros',
                ],
                [
                    'text' => 'Movimentações',
                    'url' => '/relatorio/movimentacoes',
                ],
            ],
        ],
    ],
